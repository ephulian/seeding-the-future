...
export default function Q2() {
	...
	const handleAnswer = (e) => {
		if (e.target.value.length > 0) {
			setDisabled('');
			dispatch(addAnswer({ id: 'Q2', value: e.target.value }));
		} else if (e.target.value.length <= 0) {
			setDisabled('disabled');
			dispatch(addAnswer({ id: 'Q2', value: 'empty' }));
		}
	};
			...
			<div className='question-content'>
				...
				<div className='question-container'>
					<h4>
						Q2:{' '}
						<span>
							Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi veritatis aliquid
							aspernatur error in iusto?
						</span>
					</h4>
				</div>
