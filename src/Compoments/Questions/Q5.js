...
export default function Q5() {
	...
	const handleOption = (e) => {
		setDisabled('');
		dispatch(addAnswer({ id: 'Q5', value: e.target.innerHTML }));
	};
			...
			<div className='question-content'>
				...
				<div className='answer-container'>
					<div className='single-option'>
						<input type='radio' id='option_1' name='Q5' />
					...
					<div className='single-option'>
						<input type='radio' id='option_2' name='Q5' />
						<label onClick={(e) => handleOption(e)} htmlFor='option_2'>
							Lorem ipsum dolor sit amet? Lorem ipsum dolor sit amet consectetur adipisicing elit.
						</label>
					</div>
					<div className='single-option'>
						<input type='radio' id='option_3' name='Q5' />
					...
					<div className='single-option'>
						<input type='radio' id='option_4' name='Q5' />
